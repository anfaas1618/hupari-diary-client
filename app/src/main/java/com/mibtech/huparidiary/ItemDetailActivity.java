...
import com.mibtech.huparidiary.network.LocationJson;
...
import static com.mibtech.huparidiary.ItemsActivity.mInterstitialAd;

public class ItemDetailActivity extends AppCompatActivity {
  TextView name,rank,address,email,description;
  ImageView image;
